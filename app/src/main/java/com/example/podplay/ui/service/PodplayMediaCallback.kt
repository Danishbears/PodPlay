...
class PodplayMediaCallback(val context: Context,
    ...
    interface PodlayMediaListener{
        fun onStateChanged()
        fun onStopPlaying()
        fun onPausePlaying()
    }

    var listener:PodlayMediaListener? = null
        ...
        if(newMedia){
            ...
            mediaPlayer?.let{mediaPlayer ->
                mediaUri?.let{
                  ...
                  //  mediaSession.setMetadata(MediaMetadataCompat.Builder().putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI,mediaUri.toString())
                    //    .build())
